...
// Service type is defined in service.go
...
type User struct {
	...
	CreatedAt time.Time `json:"created_at" db:"created_at" time_format:"2006-01-02T15:04:05Z07:00"`
	UpdatedAt time.Time `json:"updated_at" db:"updated_at" time_format:"2006-01-02T15:04:05Z07:00"`
}
